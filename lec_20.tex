...
\begin{bemerkung*}
  ...
  \( \funcmax; \) analog.
\end{bemerkung*}
\begin{satz}[Beppo-Levi, Satz über monotone Konvergenz]\label{beppo-levi-einfach}\index[theorems]{Satz über monotone Konvergenz (Beppo Levi)}
...
\begin{satz}[Fatou]\label{fatou}\index[theorems]{Satz von Fatou}
...
\begin{proof}
  ...
  \end{align*}
\end{proof}
\begin{satz}[Lebesgue, majorisierte Konvergenz]\label{majorisierte_konvergenz}\index[theorems]{Satz von der majorisierten Konvergenz (Lebesgue)}
