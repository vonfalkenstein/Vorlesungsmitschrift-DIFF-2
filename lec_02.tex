...
\begin{definition}
    ...
    \begin{align*}
        \forall \varepsilon>0 \logicspace \exists N\in \naturals \logicspace\text{\sd} d(y_n, y_m)<\varepsilon \logicspace \forall n,m\geq N.
    \end{align*} 
\end{definition}
\begin{lemma}
...
\begin{beispiele}
    \begin{enumerate}
        ...
        \item \label{r_ist_vollstaendig} \( \reals ,\abs{\cdot} \) ist vollständig (Diff \Romannum{1}).
...
\begin{satz}[Banach'scher Fixpunktsatz]
