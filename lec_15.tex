...
\end{bemerkung*}
\begin{satz}[Picard-Windelöf]\label{picard-windeloef}
   ...
   \begin{enumerate}
     ...
     \begin{gather*}
       ...
       u_0(t)=x_0\implies \begin{aligned}[t]
         ...
         &=x_0\left( 1+t^2+\frac{t^4}{2} \right).
       \end{aligned}
     \end{gather*}
     Per Induktion beweist man
     \begin{align*}
       &u_k(t)=x_0\left( 1+t^2+\frac{t^4}{2}+\frac{t^6}{\Factorial{3}}+\dotsb+\frac{t^{2k}}{\Factorial{k}} \right)\\
