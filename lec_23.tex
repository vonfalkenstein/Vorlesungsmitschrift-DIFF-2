...
\begin{erinnerung*}
  ...
  \end{align*}
\end{erinnerung*}
\begin{satz}[Integralsatz von Gauß]\index[theorems]{Integralsatz von Gauß}\label{integralsatz_gauss}
