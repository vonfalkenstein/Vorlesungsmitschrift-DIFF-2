...
\begin{defsatz}
    ...
    \begin{align*}
        T\definedas \Set{U\subset X\times X |\allowbreak U = \text{beliebige Vereinigung von Mengen der Form }V\times W,\allowbreak V\in \mathcal{T}_X,\allowbreak W\in \mathcal{T}_Y}
    \end{align*}
...
\begin{beispiele*}
    \begin{enumerate}[label=\rechtsklammer{\roman*}, ref=\rechtsklammer{\roman*}]
        ...
        \end{cases}
         ...
         \item\label{metrik:beispiele:r_n} (aus AGLA \Romannum{1}) \( \reals^n \), \( d(x,y)=\sqrt{\sum_{i=1}^{n} (x_i-y_i)^2} \), \enquote{Euklidische Metrik}.
    \end{enumerate}
\end{beispiele*}
...
\begin{bemerkungen}
    \begin{enumerate}
        ...
        \item Ein metrischer Raum ist Haussdorfsch. \tto HA. %ChkTeX 13
...
\begin{bemerkungen}
    ...
    \begin{enumerate}
        ...
        \item {}[\thref{stetigkeit_in_topologischen_raeumen}]\label{stetigkeit_in_metrischen_raeumen} Sei \( (Y,\tilde{d}) \) weiterer metrischer Raum, \( f\maps X to Y \) eine Abbildung. Dann ist \( f \) stetig \( a \) \gdw:
        \begin{align*}
...
\begin{beispiele}
    \begin{enumerate}
        ...
        \item \( X=\glattefunktionen(\interval{a}{b}) \), \( d(f,g)\definedas \supnorm{f-g} \) mit \( \supnorm{f-g}=\sup_{x\in \interval{a}{b}}\abs{f(x)-g(x)} \).
        \begin{enumerate}[label=\textbf{\arabic*. Beh}]
            ...
            \item \( (f_n)_n\subset \glattefunktionen(\interval{0}{1}) \), \( f_n(x)=x^n \), konvergiert nicht (\vgl Diff \Romannum{1}).
            \begin{proof}
        ...
        \item \( X=\glattefunktionen(\interval{0}{1}) \), \( d(f,g)=\Integrate{\abs{f(x)-g(x)}}{x,0,1} \).
        \begin{enumerate}[label=\textbf{\arabic*. Beh}]
            
            \item \( d \) ist eine Metrik auf \( \glattefunktionen(\interval{0}{1}) \).
            \begin{proof}
                HA. % ChkTeX 13 
            \end{proof}
            
            \item \( (f_n)_n\subset \glattefunktionen(\interval{0}{1}) \), \( f_n(x)=x^n \) konvergiert, und zwar gegen \( f(x)=0\logicspace\forall x \).
            \begin{proof}
                \begin{align*}
                    &\Integrate{\abs{f_n(x)-0}}{x,0,1}=\Integrate{x^n}{x,0,1}=\frac{1}{n+1}\evaluatebetween{x^{n+1}}{x}{0}{1}=\frac{1}{n+1}\\ % ChkTeX 29
